      ...
      <ul>
       ...
       <li class="active"><a href="#">View All</a>
          <ul>
            ...
            <li class="active"><a href="RetailerSelectAll.jsp?sessionId=<%=request.getParameter("sessionId")%>">View All Retailers</a></li>
...
%>
<body><br><br>
<table align="center" border="10" bordercolor="white"><br><br>
<tr style="color:gold;font-size:100%">
<th>Retailer Name</th>
<th>Retailer Address</th>
<th>Retailer City</th>

<th>Retailer Email ID</th>
