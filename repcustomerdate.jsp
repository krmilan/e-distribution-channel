...
%>
 ...
 %>
		...
		<div align="center">
			<h2>
				<br></br><b >Customer Product Detail</b>
			</h2>
		</div>
		<form method="post">
			<table align="center">
			...
			<div id="print" style="height: 360px; overflow: auto">
				<table align="center" border="1" bordercolor="#B2C629">
					<br></br><tr bgcolor="black">
						...
						<th style="color: #B2C629;">customer Phone Number</th>
						<th style="color: #B2C629;">Product Name</th>
						<th style="color: #B2C629;">coustomer Price</th>
					...
					<%
						...
						String nam = "select c.cname,c.cemail,c.cphone,p.pname,p.cprice,cp.cpodate from cpur_order cp,prod_mrf_detail pf,customer c,product p where cp.cid=c.cid and cp.cpmid=pf.pmid and pf.pid=p.pid and cp.cpodate>='"
								+ search + "' and cp.cpodate<='" + search1 + "'";
