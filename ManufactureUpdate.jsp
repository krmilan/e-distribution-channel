...
<%
		int mid=Integer.parseInt(request.getParameter("mid"));
         Manufacture user = new ManufactureDAO().getManu(mid) ;
%>

<form name="form" action="manufactureupdate" id=payment>
...
<table align="center"cellpading=20px cellspacing=30px border=6 bordercolor=white>
		<tr>
		<td align="center" colspan=2 style="color:black; background:orange;"> <big><b>Manufacture Update</b></big></td></tr>

    

<tr><td>Manufacture ID</td><td><input type="text" name="mid" readonly value="<%=user.getMid() %>"></td></tr>
<tr><td>Manufacture Name</td><td><input type="text" name="mname" readonly value="<%=user.getMname() %>"></td></tr>
<tr><td>Address</td><td><input type="text" name="maddress"  value="<%=user.getMaddress() %>"></td></tr>
<tr><td>Manufacture Email</td><td><input type="text" name="memail" value="<%=user.getMemail() %>"></td></tr>
<tr><td>Manufacture Phone Number</td><td><input type="text" name="mphone" value="<%=user.getMphone() %>"></td></tr>
<tr><td>Country</td><td><input type="text" name="country" readonly value="<%=user.getCountry() %>"></td></tr>
