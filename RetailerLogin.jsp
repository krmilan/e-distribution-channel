...
%>
	...
	<form action="applogconn.jsp" method="post">
		<table  height="135%" width="50%" cellspacing="18"> 
			<tr>
			<td rowspan="6">
			<img alt="Web Store" src="./images/rlogin.jpg" width="800" height="500"></img>
			</td>
			
			<td align="center" colspan=2 style="color:white; background:red; border-radius: 40px;"><big>RETAILER LOGIN</big></td></tr>
			<tr>
			<td>Retailer Name </td>
			<td><input type="text" name="uname" required placeholder="Enter Retailer Name"  required="required" autofocus /></td>
			</tr>
			<tr>
