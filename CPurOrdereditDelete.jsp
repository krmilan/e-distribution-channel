...
<body>
   <%
	...
	<table  border="2">
	<tr><td>Purchase Order Date</td><td>Purchase Manufacture Id</td><td>Quantity</td><td>Retailer ID</td><td>Customer ID</td></tr>
		<%
			...
			<input type="hidden" name="cpono" value="<%=temp.getCpono() %>" />
				...
				<tr>
					...
					<td><%=temp.getCdid() %></td>
					<td><%=temp.getCid() %></td>
					<td><input type="button" value ="Delete" onclick="fnDeleteManu(<%=temp.getCpono() %>)" /></td>
