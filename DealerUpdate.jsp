...
<%
		int did=Integer.parseInt(request.getParameter("did"));
         Dealer user = new DealerDAO().getDeal(did) ;
%>

<form name="form" action="dealerupdate" id=payment>
...
<table align="center"cellpading=20px cellspacing=30px border=6 bordercolor=white>
		<tr>
		<td align="center" colspan=2 style="color:black; background:orange;"> <big><b>Dealer Update</b></big></td></tr>

    
<tr><td>Dealer ID</td><td><input type="text" name="did" readonly value="<%=user.getDid() %>"></td></tr>
<tr><td>Dealer Name</td><td><input type="text" name="dname" readonly value="<%=user.getDname() %>"></td></tr>
<tr><td>Dealer Address</td><td><input row=4 col=4 type="text" name="daddress" value="<%=user.getDaddress() %>"></td></tr>
<tr><td>Email Id</td><td><input type="text" name="demail" value="<%=user.getDemail() %>"></td></tr>
<tr><td> Phone Number</td><td><input type="text" name="dphone" value="<%=user.getDphone() %>"></td></tr>
