      ...
      <ul>
       ...
       <li><a href="#">View All</a>
          <ul>
            ...
            <li  class="active"><a href="ManufactureSelectAll2.jsp?sessionId=<%=request.getParameter("sessionId")%>">View All  Manufacturers</a></li>
...
%>
    <body><br><br>
<table align="center" border="10" bordercolor="white">
<br><br>
<tr style="color:white;font-size:100%">
<th>Manufacture Name</th>
<th>Manufacture Address</th>
<th>Manufacture Email ID</th>
<th>Manufacture Phone Number</th>
