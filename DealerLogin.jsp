...
%>
	...
	<form action="dealogconn.jsp" method="post">
		<table  height="135%" width="50%" cellspacing="18"> 
			<tr>
			<td rowspan="6">
			<img alt="Web Store" src="./images/login12.jpg" width="700" height="400"></img>
			</td>
			
			<td align="center" colspan=2 style="color:white; background:red; border-radius: 40px;"><big>DEALER LOGIN</big></td></tr>
			<tr>
			<td>Dealer Name </td>
			<td><input type="text" name="uname" required placeholder="Enter Dealer Name"  required="required" autofocus /></td>
			</tr>
			<tr>
