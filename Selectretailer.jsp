...
<body id="top" bgcolor="gray">
	...
	<div class="wrapper col1">
		<h1>
			<a href="index.jsp"></a><img src="images/dclog.jpg" width=1340 height=150></img>
		</h1>
		<div id="header">
    <%
				...
				<ul>
					...
					<li><a href="#">Manufacture</a>
						<ul>
							...
							<li><a href="ManufactureEditDelete.jsp?sessionId=<%=request.getParameter("sessionId")%>">Edit/Delete
									Manufacture</a></li>
					...
					<li><a href="#">View</a>
						<ul>
							...
							<li><a href="ManufactureSelectAll2.jsp?sessionId=<%=request.getParameter("sessionId")%>">ViewManufacturers</a></li>
...
%>
    ...
    <br class="clear" />
					...
					<form name="retform" id=payment>
						<br>
						<br>
						
						<table align="center"><br><br><br>
<tr><td><b>Select Retailer Name </b></td><td>
<td>
			<select name="search" selected="selected" required="required">
			<%
			
			String sql1 = "select distinct rname from retailer";
					...
					<div id="print" style="height: 360px;">
						<table align="center" border="1" bordercolor="#B2C629">
							<tr bgcolor="black">
								...
								<th style="color: #B2C629;">Retailer Address</th>
								<th style="color: #B2C629;">city</th>
								<th style="color: #B2C629;">retailer Email</th>
								<th style="color: #B2C629;">Retailer Phone</th>
							...
							<%
								...
								String sql = "select distinct rid,rname,raddress,city,remail,rphone,reg_date from retailer where rname='"+search+"'";
