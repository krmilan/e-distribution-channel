...
%>
 ...
 %>
		...
		<div align="center">
			<h2>
				<br></br><b>Dealer Product Detail</b>
			</h2>
		</div>
		<form method="post">
			<table align="center">
			...
			<div id="print" style="height: 360px; overflow: auto">
				<table align="center" border="1" bordercolor="#B2C629">
					<br></br><tr bgcolor="black">
						...
						<th style="color: #B2C629;">Dealer Phone Number</th>
					...
					<%
						...
						String nam = "select d.dname,d.demail,d.dphone,p.pname,dp.dqty,p.dprice,dp.dpodate from dpur_order dp,prod_mrf_detail pf,dealer d,product p where dp.did=d.did and dp.dpmid=pf.pmid and pf.pid=p.pid and dp.dpodate>='"
								+ search + "' and dp.dpodate<='" + search1 + "'";
