...
<tr><td><b>Select Manufacture Name </b></td><td>
<td>
			<select name="search" selected="selected" required="required">
			<%
			
			String sql1 = "select distinct mname from manufacture";
					...
					<div id="print" style="height: 360px;">
						<table align="center" border="1" bordercolor="#B2C629">
							<tr bgcolor="black">
								...
								<th style="color: #B2C629;">Manufacture Address</th>
								<th style="color: #B2C629;">Manufacture Email</th>
								<th style="color: #B2C629;">Manufacture Phone</th>
								<th style="color: #B2C629;">Country</th>

							</tr>
							<%
								String search = request.getParameter("search");
								System.out.println(search);
								String sql = "select distinct mid,mname,maddress,memail,mphone,country from manufacture where mname='"+search+"'";
