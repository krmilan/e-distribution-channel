...
function selfload()
{
	document.form1.action="rprodecider.jsp";
...
<table  cellspacing="20" align="center">
	<tr><td align="left" colspan=3 width="79%" style="color:lightgreen; font_size:24; "> <big>Retailer Product Decider</big></td></tr>
...
String sql="select p.pid,r.rid,r.rname,r.rphone,p.pname,p.model,p.rprice,pf.pmid,d.did from prod_mrf_detail pf,retailer r,product p,dealer d,rpur_order rp where rp.rid=r.rid and pf.pid=p.pid and pf.pmid=rp.rpmid and p.pname='"+pname+"' and p.status='available' group by pname";
...
<td><a href="RPurOrderInsert.jsp?pid=<%=gc1.rs1.getInt(1)%>&mid=<%=gc1.rs1.getInt(8)%>&did=<%=gc1.rs1.getString(9)%>&pname=<%=pname%>">Book Now...</a></td>
